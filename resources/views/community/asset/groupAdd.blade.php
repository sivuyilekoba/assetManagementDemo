    ...
    <div class="content-wrapper" style="background-color: transparent; border-left:0px;">
        ...
        <section class="content">
            ...
            <div class="row">
                ...
                <h3 style="margin-top:-1px; color:black; float:left">Add Primary Group</h3>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="desc" name="desc" class="form-control" style="background-color:rgba(0, 0, 0, 0.5); border:none; border-radius:5px; box-shadow: 0 0 1rem 0 rgba(0, 0, 0, .2); color:white; width:100%;" required/>
