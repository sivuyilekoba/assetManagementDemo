    ...
    <div class="content-wrapper" style="background-color: transparent; border-left:0px;">
        ...
        <section class="content">
            ...
            <div class="row">
                ...
                <h3 style="margin-top:-1px; color:black; float:left">Add Community Asset Notes/ Comments</h3>
                <a class="btn add" href="/Community/notes/{{$id}}"><i class="fa fa-arrow-left"></i>  Back</a>
                <br>
                <br>
                <br>
                ...
                <div class="col-md-12">
                  ...
                  <br>
                  <form method="post" action="{{ route('Community.notesStore', $id) }}" enctype="multipart/form-data">
                        @csrf  
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="dec" name="desc" rows="5" class="form-control" style="background-color:rgba(0, 0, 0, 0.5); border:none; border-radius:5px; box-shadow: 0 0 1rem 0 rgba(0, 0, 0, .2); color:white; width:100%;" required></textarea>
