    ...
    <div class="content-wrapper" style="background-color: transparent; border-left:0px;">
        ...
        <section class="content">
            ...
            <div class="row">
                ...
                <h3 style="margin-top:-1px; color:black; float:left">Schedule Assessment</h3>
                <a class="btn add" href="{{route('Community.show', $property->id)}}"><strong><i class="fa fa-arrow-left"></i>  Back</strong></a>
                <br>
                <br>
                <br>
                ...
                <div class="col-md-10">
                    ...
                    <br>
                    <br>
                    <form role="form" method="post" action="{{ route('CommunityAssessment.store', $property->id) }}" enctype="multipart/form-data">
                        @csrf  
                        <div class="box-body">
