    ...
    <div class="content-wrapper" style="background-color: transparent; border-left:0px;">
        <section class="content-header">
            <h1 style="color:black">
                ...
                <a class="btn add" href="/CommunityAssessment/navigator/{{$id}}"><strong><i class="fa fa-arrow-left"></i>  Back</strong></a>
            </h1>            
        </section>
        <br>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card" style="background: #FFF;">
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li role="presentation"><a href="#messages" aria-controls="messages" role="tab" data-toggle="tab">Building/Structure</a></li>
                            @foreach($sector AS $s) 
                                <li role="presentation"><a href="#sector{{$s->sector_no}}" aria-controls="sector{{$s->sector_no}}" role="tab" data-toggle="tab" style="white-space: nowrap;">{{$s->sector_no}}) {{$s->description}}</a></li>
                            @endforeach
                            <li role="presentation"><a href="#" aria-controls="messages" role="tab" data-toggle="tab" style="visibility:hidden">Building idmfsf</a></li>
                        </ul>
                        <!-- Tab panes -->
                        <div class="tab-content" style="background: #FFF;">
                            <div role="tabpanel" class="tab-pane active" id="home">
                                <legend>Property Condition Overview</legend>
                                <div class="row">                                    
                                    <div class="col-md-6">                                        
                            ...
                            <script>
                                $(document).ready(function () {
                                    $('#myModal').on('show.bs.modal', function (e) {
                                        var img = '{{$assessment[0]->signature}}';
                                        $('#showimg').attr('src' , img);
                                    });
                                });
                            </script>
                            <div role="tabpanel" class="tab-pane" id="profile">
                                <legend>Assessment Signed Information</legend>
                                <br>
                                <div class="row">
                                    <div class="col-md-3">
                                        <h5>Assessor Signature:</h5>
                                        <hr>
                                    ...
                                    <div class="col-md-3">
                                        <h5><a href="#" data-target="#myModal" data-toggle="modal">Click View Signed Signature</a></h5>
                                        <hr>
                                        <h5>@if($assessment[0]->superIntendent != '') Electronically Signed By @else Not signed @endif</h5>
                                        <hr>
                                        <h5>@if($assessment[0]->deputyDirector != '') Electronically Signed By @else Not signed @endif</h5>
                                        <hr>
                                        <h5>@if($assessment[0]->director != '') Electronically Signed By @else Not signed @endif</h5>
                                        <hr>
                                    </div>
                                    <div class="col-md-3">
                                        <h5>{{$assessment[0]->a1}} {{$assessment[0]->a2}}</h5>
                                        <hr>
                                        <h5>@if(isset($assessment[0]->superIntendent) && $assessment[0]->superIntendent != '')
                                                {{$assessment[0]->superIntendent_fullname}}
                                            @else 
                                                N/A
                                            @endif
                                        </h5>
                                        <hr>
                                        <h5>@if(isset($assessment[0]->deputyDirector) && $assessment[0]->deputyDirector != '')
                                                {{$assessment[0]->deputyDirector_fullname}}
                                            @else 
                                                N/A
                                            @endif
                                        </h5>
                                        <hr>
                                        <h5>@if(isset($assessment[0]->director) && $assessment[0]->director != '')
                                                {{$assessment[0]->director_fullname}}
                                            @else 
                                                N/A
                                            @endif
                                        </h5>
                                    ...
                                    <div class="col-md-3">
                                        <h5>Date: {{$assessment[0]->date_of_assessment}}</h5>
                                        <hr>                
                                        <h5>Date: {{$assessment[0]->superIntendent_date}}</h5>
                                        <hr>
                                        <h5>Date: {{$assessment[0]->deputyDirector_date}}</h5>
                                        <hr>
                                        <h5>Date: {{$assessment[0]->director_date}}</h5>
                                        <hr>
                                    </div>                                    

                                    <div class="col-md-12">
                                        <br>
                                        <legend>Assessment Summary</legend>
                                        <br>
                                        <table style="width:100%; padding:7px" border="1">
                                            <tbody>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td style="padding:3px; background-color:#a5a5a5"></td>
                            ...
                            <div role="tabpanel" class="tab-pane" id="messages">
                                <legend>Assessment Building/Structural <a class="btn add" href="/CommunityAssessment/images/{{$id}}/building" style="margin-top:-10px"><strong><i class="fa fa-camera"></i>  Images</strong></a></legend>
                                <div class="row">
                                    <div class="col-md-12">
                                        <table style="width:100%; padding:7px" border="1">
                                            <tbody>
                                                <tr>
                                                    <td style="padding:7px;font-size:1.1vw; background-color:rgb(229, 229, 229, 0.5);" colspan="8"><center><strong>EXTERNAL ENVELOPE ASSESSMENT - Building/Structural</strong></center></td>
                                                </tr>
                                                <tr>
                                                    <td style="padding:7px; background-color:#E29F3C; font-size:1.1vw;" colspan="2"><center><strong>ITEM INFORMATION</strong></center></td>
                                                    <td style="padding:7px; background-color:#E29F3C; font-size:1.1vw;" colspan="6"><center><strong>ASSESSMENT CRITERIA</strong></center></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td style="padding:7px;font-size:1.1vw; background-color:#E29F3C;" colspan="7"><strong style="float:right">Average Condition Rating (CR)</strong></td>
                                        ...
                                        <table style="width:100%; padding:7px" border="1">
                                            <tbody>
                                                <tr>
                                                    <td style="padding:7px;font-size:1.1vw; background-color:rgb(229, 229, 229, 0.5);" colspan="8"><center><strong>CIVILS ASSESSMENT - Building/Structural</strong></center></td>
                                                </tr>
                                                <tr>
                                                    <td style="padding:7px; background-color:#E29F3C; font-size:1.1vw;" colspan="2"><center><strong>ITEM INFORMATION</strong></center></td>
                                        ...
                                        <table style="width:100%; padding:7px" border="1">
                                            <tbody>
                                                <tr>
                                                    <td style="padding:7px;font-size:1.1vw; background-color:rgb(229, 229, 229, 0.5);" colspan="8"><center><strong>MECHANICAL ASSESSMENT - Building/Structural</strong></center></td>
                                                </tr>
                                                <tr>
                                                    <td style="padding:7px; background-color:#E29F3C; font-size:1.1vw;" colspan="2"><center><strong>ITEM INFORMATION</strong></center></td>
                                                    <td style="padding:7px; background-color:#E29F3C; font-size:1.1vw;" colspan="7"><center><strong>ASSESSMENT CRITERIA</strong></center></td>
                                        ...
                                        <table style="width:100%; padding:7px" border="1">
                                            <tbody>
                                                <tr>
                                                    <td style="padding:7px;font-size:1.1vw; background-color:rgb(229, 229, 229, 0.5);" colspan="8"><center><strong>ELECTRICAL ASSESSMENT - Building/Structural</strong></center></td>
                                                </tr>
                                                <tr>
                                                    <td style="padding:7px; background-color:#E29F3C; font-size:1.1vw;" colspan="2"><center><strong>ITEM INFORMATION</strong></center></td>
                                                    <td style="padding:7px; background-color:#E29F3C; font-size:1.1vw;" colspan="7"><center><strong>ASSESSMENT CRITERIA</strong></center></td>
                                        ...
                                        <table style="width:100%; padding:7px" border="1">
                                            <tbody>
                                                <tr>
                                                    <td style="padding:7px;font-size:1.1vw; background-color:rgb(229, 229, 229, 0.5);" colspan="8"><center><strong>SOFT SERVICES ASSESSMENT - Building/Structural</strong></center></td>
                                                </tr>
                                                <tr>
                                                    <td style="padding:7px; background-color:#E29F3C; font-size:1.1vw;" colspan="2"><center><strong>ITEM INFORMATION</strong></center></td>
                                                    <td style="padding:7px; background-color:#E29F3C; font-size:1.1vw;" colspan="7"><center><strong>ASSESSMENT CRITERIA</strong></center></td>
                            ...
                            @foreach($sector AS $s) 
                                ...
                                <div role="tabpanel" class="tab-pane" id="sector{{$s->sector_no}}">
                                    <legend>Sector {{$s->sector_no}} - {{$s->description}} <a class="btn add" href="/CommunityAssessment/images/{{$id}}/{{$s->id}}" style="margin-top:-10px"><strong><i class="fa fa-camera"></i>  Images</strong></a></legend>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <table style="width:100%; padding:7px" border="1">
                                                <tbody>
                                                    <tr>
                                                        <td style="padding:7px;font-size:1.1vw; background-color:rgb(229, 229, 229, 0.5);" colspan="8"><center><strong>INTERNAL ENVELOPE ASSESSMENT</strong></center></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="padding:7px; background-color:#E29F3C; font-size:1.1vw;" colspan="2"><center><strong>ITEM INFORMATION</strong></center></td>
                                                        <td style="padding:7px; background-color:#E29F3C; font-size:1.1vw;" colspan="7"><center><strong>ASSESSMENT CRITERIA</strong></center></td>
                                            ...
                                            <table style="width:100%; padding:7px" border="1">
                                                <tbody>
                                                    <tr>
                                                        <td style="padding:7px;font-size:1.1vw; background-color:rgb(229, 229, 229, 0.5);" colspan="8"><center><strong>MECHANICAL ASSESSMENT</strong></center></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="padding:7px; background-color:#E29F3C; font-size:1.1vw;" colspan="2"><center><strong>ITEM INFORMATION</strong></center></td>
                                                        <td style="padding:7px; background-color:#E29F3C; font-size:1.1vw;" colspan="7"><center><strong>ASSESSMENT CRITERIA</strong></center></td>
                                            ...
                                            <table style="width:100%; padding:7px" border="1">
                                                <tbody>
                                                    <tr>
                                                        <td style="padding:7px;font-size:1.1vw; background-color:rgb(229, 229, 229, 0.5);" colspan="8"><center><strong>ELECTRICAL ASSESSMENT</strong></center></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="padding:7px; background-color:#E29F3C; font-size:1.1vw;" colspan="2"><center><strong>ITEM INFORMATION</strong></center></td>
                                                        <td style="padding:7px; background-color:#E29F3C; font-size:1.1vw;" colspan="7"><center><strong>ASSESSMENT CRITERIA</strong></center></td>
