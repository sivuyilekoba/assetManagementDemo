    ...
    <div class="content-wrapper" style="background-color: transparent; border-left:0px;">
        ...
        <section class="content">
            ...
            <div class="row">
                ...
                <h3 style="margin-top:-1px; color:black; float:left">Edit Schedule Assessment</h3>
                <a class="btn add" href="/CommunityAssessment/"><strong><i class="fa fa-arrow-left"></i>  Back</strong></a>
                <br>
                <br>
                <br>
                ...
                <div class="col-md-10">
                    ...
                    <br>
                    <br>
                    <form role="form" method="post" action="{{ route('CommunityAssessment.update', $assessment[0]->id) }}" enctype="multipart/form-data">
                        @csrf  
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div id="step1">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="date" id="date" value="{{$assessment[0]->date_of_assessment}}" style="background-color:rgba(0, 0, 0, 0.5); border:none; border-radius:5px; box-shadow: 0 0 1rem 0 rgba(0, 0, 0, .2); color:white; width:100%;" required><br>
                                            <script>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="time" id="time" name="time" value="{{$assessment[0]->time_of_assessment}}" style="background-color:rgba(0, 0, 0, 0.5); border:none; border-radius:5px; box-shadow: 0 0 1rem 0 rgba(0, 0, 0, .2); color:white; width:100%;" required/>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="assessor_listbox" id="assessor_listbox" size="15" style="background-color:rgba(0, 0, 0, 0.1); border-color:#950000; border-radius:5px; box-shadow: 0 0 1rem 0 rgba(0, 0, 0, .2); color:black; width:100%;" onChange="changecata(this.value);" readonly="readonly" required>
                                                <option value="{{$assessment[0]->assessor_id}}">{{$assessment[0]->a1}} {{$assessment[0]->a2}}</option>
                                ...
                                <div id="step3" style="display:none">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="comments" style="color:black">Asset Comments</label>
                                            <input type="text" value="{{$assessment[0]->comment}}" class="form-control" name="comments" id="comments" style="background-color:rgba(0, 0, 0, 0.5); border:none; border-radius:5px; box-shadow: 0 0 1rem 0 rgba(0, 0, 0, .2); color:white;">
